...
public class RegisterActivity extends Activity {
    ...
    private AmbilWarnaDialog color_dialog;
    private int r = 0;
    private int g = 0;
    private int b = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnChooseColor = (Button) findViewById(R.id.btnColor);

        color_dialog = new AmbilWarnaDialog(this, 0x00000000, false, new AmbilWarnaDialog.OnAmbilWarnaListener() {
            @Override
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !(r==0 && g==0 && b==0)) {
                    registerUser(name, email, password, hex_color);
                } else {
                    Toast.makeText(getApplicationContext(),
                            "Please enter your details and choose a player color!", Toast.LENGTH_LONG)
                            .show();
                }
            }
        });
    ...
    private void registerUser(final String name, final String email,
                              final String password, final String hex_color) {
        ...
        StringRequest strReq = new StringRequest(Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        //db.addUser(name, email, user_id, hex_color, created_at);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("hex_color", hex_color);
                return params;
            }
